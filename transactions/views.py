...
from accounts import integrations
...
class DepositMoneyView(TransactionCreateMixin):
    ...
    def form_valid(self, form):
        ...
        if kyc:
            ...
            integrations.categorise_transaction(
                self.request.user, f'deposit of {amount}'
            )
        integrations.track_transaction(self.request.user, amount)
